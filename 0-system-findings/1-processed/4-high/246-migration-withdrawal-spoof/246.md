...
- [246.md](processed/high/migration/246.md): #high
  - **Description:** Pre-Bedrock withdrawals are spoofable
  - **Reason:** This looks like a legitimate report. Someone has already called the message passer directly on mainnet.
  - **Action:** Add the specified fixes
